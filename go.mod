module github.com/aditsachde/itko-serverless-witness

go 1.23.1

replace github.com/transparency-dev/witness => ./witness

require (
	cloud.google.com/go/secretmanager v1.14.1
	github.com/transparency-dev/witness v0.0.0-20240916102203-da7090723a07
)
